...
public class IEnchant extends RInventory {
    ...
    private void updateInventory() {
        ...
        if (player.getItemInHand().hasItemMeta() && Objects.requireNonNull(player.getItemInHand().getItemMeta()).isUnbreakable())
    ...
    private Consumer<InventoryClickEvent> updateUnbreakable() {
        return e -> {
            ...
            Objects.requireNonNull(player.getItemInHand().getItemMeta()).setUnbreakable(!player.getItemInHand().getItemMeta().isUnbreakable());
            updateInventory();
        };
    }
